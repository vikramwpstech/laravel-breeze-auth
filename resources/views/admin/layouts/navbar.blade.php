<nav class="navbar navbar-dark col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
    <div class="me-3">
        <button id="minimizeButton" class="navbar-toggler navbar-toggler align-self-center" type="button" data-bs-toggle="minimize">
    ...
    <ul class="navbar-nav">
        ...
        <h1 class="welcome-text"><span class="text-white">Hey,</span> <span class="text-black fw-bold">{{ Auth::guard('admin')->user()->name}}</span></h1>
        <h3 class="welcome-sub-text text-white">Your performance summary this week </h3>
        </li>
    </ul>
